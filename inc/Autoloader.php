...
final class Autoloader {
	...
	public static function autoload(): bool {
		...
		if ( defined( 'ONEMEDIA_AUTOLOAD' ) && false === ONEMEDIA_AUTOLOAD ) {
			return true;
		}
		...
		$autoloader      = ONEMEDIA_DIR . 'vendor/autoload.php';
		...
		foreach ( $hooks as $hook ) {
			add_action(
				...
				static function (): void {
					$error_message = __( 'OneMedia: The Composer autoloader was not found. If you installed the plugin from the GitHub source code, make sure to run `composer install`.', 'onemedia' );
